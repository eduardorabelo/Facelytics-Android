...
public class SampleCameraActivity extends Activity {
	...
	final OnEventListener<?> eventListener = new OnFaceListener() {
		...
		public void onEvent(String rawEvent) throws JSONException {
			...
			SampleCameraActivity.this.doSomethingWithEvent(getEvent());
		}
	};
	...
	final SessionEndedListener sessionEndedListener = new SessionEndedListener() {
		...
		public void ended() {
			runOnUiThread(new Runnable() {
				@Override
				public void run() {
					Toast.makeText(SampleCameraActivity.this, "Session ended !", Toast.LENGTH_SHORT).show();
					finish();
				}
			});
		}
	...
	protected void onResume() {
		 ...
		 */
		FacelyticsCameraServiceNative service = SampleApplication.initService_4Camera_SampleActivity(SampleCameraActivity.this, eventListener, sessionEndedListener);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
	    switch (item.getItemId()) {
	    	case R.id.action_switch:
	    	{
				...
				FacelyticsUtils.destroyInstance();
				SampleApplication
					.initService_4Camera_SampleActivity(SampleCameraActivity.this, eventListener, sessionEndedListener)
					.record(SampleCameraActivity.this, (KFrameRender) findViewById(R.id.render), true, true);
	    	...
	    	{
	    		Intent intent = new Intent(SampleCameraActivity.this, FacelyticsConfigActivity.class);
				...
				SampleCameraActivity.this.startActivity(intent);
	    		return true;
	    	}
	        default:
